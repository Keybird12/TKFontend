...
import './TavernInventory1.css';

import Sidebar from './section1/Sidebar';
import Header from './section1/Header';
import InventoryCard from './section1/InventoryCard';
import DescriptionSection from './section1/DescriptionSection';
import UsageSection from './section1/UsageSection';

export default function TavernInventory1() {
  const taverns = [
    { name: 'Ale', id: '1011', highlighted: false, image: '/images/Ale.png', route: '/inventory' },
    { name: 'Whiskey', id: '1012', highlighted: true, image: '/images/Whiskey.png', route: null },
